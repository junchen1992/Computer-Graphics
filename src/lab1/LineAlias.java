...
public abstract class LineAlias {
	...
	/*
	 * public static int ipart(float x) { return (int) x; }
	 * 
	 * public static int round(float x) { return ipart(x + 0.5); }
	 * 
	 * public static float fpart(float x) { if (x < 0) return (float) (1 - (x -
	 * Math.floor(x))); return (float) ((float) x - Math.floor(x)); }
	 * 
	 * public static float rfpart(float x) { return (float) 1 - fpart(x); }
	 */
